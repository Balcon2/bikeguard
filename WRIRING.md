...
| ------------------------------------- | ------------- | ------------------- | ----------------------- |
| **MPU6050 IMU**                       | VCC           | 3V3                 | Power                   |
| **MPU6050 IMU**                       | GND           | GND                 | Ground                  |
| **MPU6050 IMU**                       | SDA           | GPIO8               | I²C Data                |
| **MPU6050 IMU**                       | SCL           | GPIO9               | I²C Clock               |
...
The **MPU6050** and **SSD1306 OLED** share the same I²C bus:
